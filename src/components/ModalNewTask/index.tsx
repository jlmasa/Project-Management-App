...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const [authorUserId, setAuthorUserId] = React.useState<string>("");
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
      ...
      >
        ...
        <div className="grap-6 grid grid-cols-1 sm:grid-cols-2 sm:gap-2">
          <select
        ...
        />
        <div className="grid-col-1 grid gap-6 sm:grid-cols-2 sm:gap-2">
          <input
            type="date"
            className={inputStyles}
            value={startDate}
